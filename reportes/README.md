...
| **Incertidumbre Metrologica ISO/GUM** | Modelo estocástico de propagación de errores, ajuste Gaussiano 2D / Donut LG01 y resolución sub-píxel ($\approx 0.35\ \text{nm}$). | [Incertidumbre_Metrologica_PyPrinting3.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/cientificos/Incertidumbre_Metrologica_PyPrinting3.md) |
