...
```
reportes/
├── ⚙️ sistema/          # Reportes de Estado del Sistema, Arquitectura, Hardware e Ingeniería
└── 🔬 cientificos/       # Reportes Científicos, Modelos Analíticos, Física y Protocolos
```
...
| **Seguridad Óptica y Watchdog** | Fail-safe activo con latido (*heartbeat*), conmutación de obturadores (`line0:3`) y corte de emergencia NI-DAQmx. | [Reporte_Seguridad_Optica_Watchdog_y_Control_de_Obturadores.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/sistema/Reporte_Seguridad_Optica_Watchdog_y_Control_de_Obturadores.md) |
| **Actuación Flipper y Watchdog Desacoplado** | Análisis de causa raíz de conmutación de potencia, ciclo de vida NI-DAQmx (tareas zombi), pulso de 5V y desacoplamiento de seguridad. | [Reporte_Tecnico_Actuacion_Flipper_y_Watchdog_Desacoplado.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/sistema/Reporte_Tecnico_Actuacion_Flipper_y_Watchdog_Desacoplado.md) |
| **Calibración Espectral y Flippers** | Ajuste gaussiano sub-píxel orden 0, offsets Ctypes Shamrock SDK, reactividad flipper Qt y Step & Glue. | [Reporte_Calibracion_Espectral_y_Actuacion_Flippers_PyPrinting3.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/sistema/Reporte_Calibracion_Espectral_y_Actuacion_Flippers_PyPrinting3.md) |
| **Espectrómetro Shamrock 500i / iXon3**| Arquitectura completa de espectrometría PySpectrum, calibraciones EEPROM y modos de adquisición. | [Reporte_Sistema_Espectrometro_Shamrock500i_iXon3_PySpectrum.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/sistema/Reporte_Sistema_Espectrometro_Shamrock500i_iXon3_PySpectrum.md) |
...
| **Algoritmo de Parada Printing y Dímeros** | Formulación matemática detallada de los 5 criterios de parada (Modos 0 a 4), filtro anti-paso $N_{\text{hold}}$ y dímeros sub-100 nm. | [Algoritmo_Printing_y_Dimers_PyPrinting3.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/cientificos/Algoritmo_Printing_y_Dimers_PyPrinting3.md) |
| **Confocal Tilt y Healing Pass** | Geometría de 4 esquinas para compensación de inclinación $Z(x,y)$, rango de Rayleigh y algoritmo de autocompletitud de redes con autofoco in-situ. | [Compensacion_de_Inclinacion_Confocal_Tilt_y_Healing_Pass_PyPrinting3.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/cientificos/Compensacion_de_Inclinacion_Confocal_Tilt_y_Healing_Pass_PyPrinting3.md) |
...
| **Contenedor Científico HDF5 (.h5)** | Serialización jerárquica de lotes, compresión lossless `shuffle+gzip`, preservación metrológica y desempaquetado 1-click. | [Contenedor_Cientifico_HDF5_PyPrinting3.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/cientificos/Contenedor_Cientifico_HDF5_PyPrinting3.md) |
