# SYS-203: Control de Fuentes Láser, Protocolos RS-232/SCPI y Modulación 💡

**PyPrinting 3.0 / PySpectrum 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Autor Principal:** José Luis González Peñafiel (*Becario Doctoral CONICET*)  
**Código del Documento:** `SYS-203` | **Eje Temático:** `[INS] (Instrumentación Láser y Comunicaciones Serie)`  
...
- **Módulos de Código Fuente:** `core/lasers.py`, `modules/hardware_dashboard.py`
