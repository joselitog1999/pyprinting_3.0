# SYS-002: Evaluación Arquitectónica AST, Métricas Graphify y Modularidad 🌳

**PyPrinting 3.0 / PySpectrum 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Autor Principal:** José Luis González Peñafiel (*Becario Doctoral CONICET*)  
**Código del Documento:** `SYS-002` | **Eje Temático:** `[ARQ] (Arquitectura de Software y Análisis Estático)`  
...
- **Módulos de Código Fuente:** `core/canon_edsdk.py`, `modules/camera.py`, `config.py`
