...
| **`camera.py`** / **`modules/camera.py`** | `camera_snapshot_*.png` / `.tiff` | `image_analyzer.py`<br>Reportes | Capturas estáticas del campo óptico de la cámara Thorlabs/USB. | 🟢 **100% Compatible**. |
