# SYS-402: Auditoría Comparativa: Andor Solis vs PySpectrum 3.0 🔬

**PyPrinting 3.0 / PySpectrum 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Autor Principal:** José Luis González Peñafiel (*Becario Doctoral CONICET*)  
**Código del Documento:** `SYS-402` | **Eje Temático:** `[AUD] (Auditoría Funcional de Software y Roadmap)`  
...
- **Módulos de Código Fuente:** `pyspectrum.py`, `pyspectrum/drivers/andor_driver.py`
