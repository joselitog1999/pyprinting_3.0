# SYS-101: Arquitectura de Hilos, Concurrencia Asíncrona y Patrones QThread 🧵

**PyPrinting 3.0 / PySpectrum 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Autor Principal:** José Luis González Peñafiel (*Becario Doctoral CONICET*)  
**Código del Documento:** `SYS-101` | **Eje Temático:** `[ARQ] (Arquitectura de Concurrencia y Sincronización)`  
...
- **Módulos de Código Fuente:** `app.py`, `modules/measurements.py`, `modules/camera.py`, `modules/confocal.py`, `core/nidaq.py`
...
- **Reportes Técnicos Vinculados**:
  - 📷 [[SYS-204_Modulo_Camara_Canon_EDSDK_y_Buffer_RAM|Módulo Cámara Canon EOS 500D]]
  - 🔌 [[SYS-102_Senales_Slots_PyQt6_y_Temporizacion_DAQmx|Diagnóstico de Señales y Conexiones]]
  - 🧮 [[CAT-103_Control_Lazo_Cerrado_Fototermico_y_Sintesis_Dimeros|Algoritmo de Parada e Impresión de Grillas]]
