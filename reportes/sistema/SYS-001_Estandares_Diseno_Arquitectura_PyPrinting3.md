# SYS-001: Estándares de Diseño, Arquitectura Integral y Estado de PyPrinting 3.0 🏛️

**PyPrinting 3.0 / PySpectrum 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Autor Principal:** José Luis González Peñafiel (*Becario Doctoral CONICET*)  
**Código del Documento:** `SYS-001` | **Eje Temático:** `[EST] (Estándares de Diseño y Gobierno de Software)`  
...
- **Módulos de Código Fuente:** `main.py`, `app.py`, `core/hardware_manager.py`, `core/preset_manager.py`, `contrapropagante.py`
...
| `measurements.py` | Rutinas de Impresión y Dímeros | 🟢 Excelente | 5 modos de parada, `Drift Correction`, `Healing Pass` (Autocompletitud) | Presets persistentes en `.txt`, exportación multimaterial, reintentos con $+10\text{s}$ y auto-recuperación. |
...
| `confocal.py` | Escaneo Confocal 2D (Rampa/Paso) | 🟢 Excelente | Corrección dinámica de inclinación Z (4 esquinas), ETA paso a paso | Generación de ondas analógicas PI (`WAV_LIN`), ajuste 2D y nivelación dinámica de plano. |
...
| `camera.py` | Visión en Vivo Canon EDSDK/USB | 🟢 Excelente | Live View 25 FPS, captura 15.1 MP, overlay en µm y Trackpy | Descarga en RAM MemoryStream inmune a errores de ruta 0x000000AB. |
| `grid_generator.py` | Diseñador Universal de Redes 2D | 🟢 Excelente | 15 familias de redes, bases $(u,v)$, slider $\gamma$, filtro $d_{\text{min}}$ y P0 | Paquetes de recetas multi-material listos para `Measurements`. |
| `pyspectrum.py` | Suite PySpectrum 3.0 | 🟢 Excelente | Espectrógrafo Shamrock, CCD Andor, Step & Glue y calibración halógena | Extinción plasmónica, cinéticas y mapas hiperespectrales 3D. |
