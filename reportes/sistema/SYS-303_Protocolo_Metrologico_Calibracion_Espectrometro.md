# SYS-303: Protocolo Metrológico de Calibración Multi-Fase del Espectrógrafo 📋

**PyPrinting 3.0 / PySpectrum 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Autor Principal:** José Luis González Peñafiel (*Becario Doctoral CONICET*)  
**Código del Documento:** `SYS-303` | **Eje Temático:** `[PRT] (Protocolo Estandarizado de Calibración - SOP)`  
...
- **Módulos de Código Fuente:** `pyspectrum/docks/calibration_dock.py`, `pyspectrum/drivers/shamrock_driver.py`
