# SYS-302: Calibración Espectral Shamrock 500i y Actuación Reactiva de Flippers 🌈

**PyPrinting 3.0 / PySpectrum 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Autor Principal:** José Luis González Peñafiel (*Becario Doctoral CONICET*)  
**Código del Documento:** `SYS-302` | **Eje Temático:** `[CAL] (Calibración Instrumental y Automatización)`  
...
- **Reportes de Sistema Conexos:**
  ...
  - `[[SYS-303_Protocolo_Metrologico_Calibracion_Espectrometro]]`
...
- **Módulos de Código Fuente:** `pyspectrum/docks/calibration_dock.py`, `core/nidaq.py`, `app.py`
...
Para un desglose matemático, cronometría del pulso de $5\ \text{V} \times 100\ \text{ms}$ y matriz de polaridades, véase el documento especializado: [`SYS-202_Actuacion_Flipper_y_Ciclo_Vida_DAQmx.md`](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/sistema/SYS-202_Actuacion_Flipper_y_Ciclo_Vida_DAQmx.md).
