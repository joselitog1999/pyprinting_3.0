# SYS-202: Actuación del Espejo Rebatible de Potencia y Ciclo de Vida DAQmx 🔀

**PyPrinting 3.0 / PySpectrum 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Autor Principal:** José Luis González Peñafiel (*Becario Doctoral CONICET*)  
**Código del Documento:** `SYS-202` | **Eje Temático:** `[INS] (Instrumentación, Actuadores y Control DAQmx)`  
...
- **Módulos de Código Fuente:** `core/nidaq.py`, `app.py`, `modules/hardware_dashboard.py`
