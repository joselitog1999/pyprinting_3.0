# SYS-301: Hardware del Espectrógrafo Shamrock 500i y Cámara iXon3 EMCCD 📑

**PyPrinting 3.0 / PySpectrum 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Autor Principal:** José Luis González Peñafiel (*Becario Doctoral CONICET*)  
**Código del Documento:** `SYS-301` | **Eje Temático:** `[INS] (Instrumentación Espectroscópica y Detectores EMCCD)`  
...
- **Módulos de Código Fuente:** `pyspectrum/drivers/shamrock_driver.py`, `pyspectrum/drivers/andor_driver.py`
...
> [Reporte Maestro de Arquitectura Óptica (`reportes/sistema/SYS-305_Arquitectura_Optomecanica_Microscopio_Derecho_y_Ruteo_Espectral.md`)](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/sistema/SYS-305_Arquitectura_Optomecanica_Microscopio_Derecho_y_Ruteo_Espectral.md).
