...
* **Modelo de Incertidumbre Metrológica (Norma ISO/GUM)**: Documentado en [`reportes/cientificos/Incertidumbre_Metrologica_PyPrinting3.md`](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/cientificos/Incertidumbre_Metrologica_PyPrinting3.md), rigurosamente calibrado con la óptica real (Olympus 60x W, relé 4f 250/200 mm, pinholes dedicados de 50 µm / 100 µm a 0.46 AU), demostrando una incertidumbre espacial combinada sub-nanométrica $u_c(x_0) = 6.55\ \text{nm}$ ($4.73\ \text{nm}$ con Nikon 100x Oil), resolución espectral de $0.46\ \text{cm}^{-1}$ y muestreo espacial óptimo $\Delta x \in [15, 25]\ \text{nm/px}$.
