...
9. 🖼️ [Deconvolución Richardson-Lucy en Tiempo Real, Trackpy y Picasso (reportes/Deconvolucion_Richardson_Lucy_y_Trackpy_PyPrinting3.md)](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/reportes/Deconvolucion_Richardson_Lucy_y_Trackpy_PyPrinting3.md): Modelo bayesiano MLE, calibración de PSF (Gaussiana, Donut, Centro de Masas), motores de detección sub-píxel Trackpy y Picasso (MLE/LQ), inversión fotométrica y caracterización metrológica.
