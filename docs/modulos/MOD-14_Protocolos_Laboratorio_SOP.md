# MOD-14: Procedimientos Operativos Estandarizados de Laboratorio (SOP) 📋

**PyPrinting 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Manual de Usuario Canónico** | **Código:** `MOD-14` | **Nivel de Usuario:** Básico / Operador / Experto  
**Alcance**: Protocolos de Laboratorio, Alineación Óptica, Síntesis Coloidal y Nanofabricación  
**Documento Fuente**: Protocolos Experimentales INS-UNSAM  
...
* **Manuales de Usuario Conexos:**
  ...
  * `[[MOD-03_Microscopio_Contrapropagante]]`
...
- [[CAT-101_Protocolo_Operativo_Impresion_Fototermica_Grillas_2D|🔬 CAT-101: Protocolo Operativo de Impresión Fototérmica]]
...
- [[CAT-110_Fisicoquimica_Coloides_DLVO_y_Funcionalizacion_Superficies|🧪 CAT-110: Fisicoquímica de Coloides, DLVO y Silanización]]
...
- [[MOD-13_Hardware_Dashboard_y_Presets|🛡️ MOD-13: Tablero de Seguridad de Hardware y Presets]]
