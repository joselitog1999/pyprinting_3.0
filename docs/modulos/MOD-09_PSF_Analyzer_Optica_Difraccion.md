# MOD-09: Analizador de PSF y Óptica Difractiva 2D 🔬

**PyPrinting 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Manual de Usuario Canónico** | **Código:** `MOD-09` | **Nivel de Usuario:** Básico / Avanzado  
**Archivos Fuente Asociados:**
- [`analysis/psf_analyzer.py`](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/analysis/psf_analyzer.py) (Ventana principal y visualizador triple sincronizado)
- [`analysis/psf.py`](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/analysis/psf.py) (Modelos no lineales de ajuste Gaussiano 2D y Donut $LG_{01}$)
...
## 6. Modelo de Ajuste 2D y Criterios Metrológicos

> [!NOTE]
> **Caja de Derivación Formal**:
> Para la deducción analítica rigurosa de la cota de Cramér-Rao en localización de PSFs Gaussianas, propagación de varianza fotónica y matrices de covarianza, consultar `[[CAT-202_Derivacion_Matematica_Cota_Cramer_Rao_Localizacion_Optica]]`. Para la teoría óptica difractiva de formación de imagen en microscopía confocal y telescopios 4f, consultar `[[CAT-108_Teoria_Optica_Telescopio_Rele_4f_y_Canales_Confocales]]`.

El modelo **Gaussiano 2D Elíptico con Rotación** implementado en [`analysis/psf.py`](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/analysis/psf.py) ajusta los 7 parámetros ópticos fundamentales $(z_0, A, x_0, y_0, \sigma_x, \sigma_y, \theta)$ mediante el algoritmo no lineal de Levenberg-Marquardt. A partir de los anchos principales $\sigma_x$ y $\sigma_y$, el software calcula el ancho a mitad de altura ($\text{FWHM} \approx 2.355\,\sigma$), el porcentaje de elipticidad ($\epsilon = 1 - \sigma_{\min}/\sigma_{\max}$) y la relación señal-fondo ($\text{SBR} = A / z_0$).
...
- [[MOD-01_Microscopio_Derecho_App]] — Control del escáner confocal y obtención de barridos `NPscan_*.tiff`.
- [[MOD-10_Image_Analyzer_Tracking]] — Deconvolución Richardson-Lucy y detección de partículas con Trackpy.
- [[CAT-202_Derivacion_Matematica_Cota_Cramer_Rao_Localizacion_Optica]] — Cota teórica de incertidumbre sub-píxel.
