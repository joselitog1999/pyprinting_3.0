# MOD-03: Microscopio Contrapropagante (Pinzas Ópticas Duales) 🔬

**PyPrinting 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Manual de Usuario Canónico** | **Código:** `MOD-03` | **Nivel de Usuario:** Experto  
...
- [[MOD-01_Microscopio_Derecho_App]] — Suite principal de microscopía confocal mono-objetivo.
- [[MOD-02_Measurements_Printing_y_Dimeros]] — Módulo de impresión fototérmica y síntesis de dímeros.
- [[MOD-09_PSF_Analyzer_Optica_Difraccion]] — Análisis y ajuste de PSFs Gaussianas y Donut LG01.
- [[CAT-109_Electrodinamica_Fuerzas_Opticas_y_Termoplasmonica_Printing]] — Electrodinámica de pinzas ópticas y termoplasmónica.
- [[CAT-203_Presupuesto_Incertidumbre_Metrologica_ISOGUM_Microscopia]] — Presupuesto metrológico de incertidumbre según ISO/GUM.
- [[SYS-201_Seguridad_Optica_Watchdog_y_Obturadores]] — Sistema de seguridad de obturadores ópticos.
