# MOD-01: Microscopio Derecho — Suite Principal (app.py) 🔬

**PyPrinting 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Manual de Usuario Canónico** | **Código:** `MOD-01` | **Nivel de Usuario:** Básico / Operador / Experto  
...
- [[MOD-02_Measurements_Printing_y_Dimeros]] — Ventana de mediciones automatizadas de impresión y dímeros.
- [[MOD-04_Camara_Live_View_Canon_EDSDK]] — Visión en vivo y centrado de haz mediante Canon EOS 500D.
- [[MOD-05_Modulacion_Laser_Potencias]] — Control de potencias y modulación de fuentes láser.
- [[MOD-07_Disenador_Redes_2D_Grid_Generator]] — Generador de mallas y coordenadas para impresión.
- [[MOD-09_PSF_Analyzer_Optica_Difraccion]] — Ajuste gaussiano 2D y análisis de frentes de onda difractivos.
- [[MOD-13_Hardware_Dashboard_y_Presets]] — Telemetría de hardware, re-scan USB y aislamiento en caliente.
- [[MOD-14_Protocolos_Laboratorio_SOP]] — Protocolos y procedimientos estandarizados de alineación e impresión.
- [[CAT-101_Protocolo_Operativo_Impresion_Fototermica_Grillas_2D]] — Protocolo de impresión fototérmica.
- [[CAT-104_Compensacion_Inclinacion_Z_Confocal_y_Healing_Pass]] — Nivelación de plano Z por escaneo en 4 esquinas.
- [[CAT-108_Teoria_Optica_Telescopio_Rele_4f_y_Canales_Confocales]] — Teoría óptica de formación de imagen confocal y 4f.
- [[SYS-101_Arquitectura_Hilos_Concurrencia_QThread]] — Arquitectura de hilos y concurrencia multicanal.
- [[SYS-201_Seguridad_Optica_Watchdog_y_Obturadores]] — Sistema de watchdog y seguridad de obturadores láser.
- [[SYS-202_Actuacion_Flipper_y_Ciclo_Vida_DAQmx]] — Control del atenuador motorizado flipper.
- [[SYS-305_Arquitectura_Optomecanica_Microscopio_Derecho_y_Ruteo_Espectral]] — Ruteo optomecánico hacia detección y espectroscopía.
