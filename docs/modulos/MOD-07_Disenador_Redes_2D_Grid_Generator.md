# MOD-07: Diseñador Universal de Redes Cristalinas 2D (Grid Generator) 📐

**PyPrinting 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Manual de Usuario Canónico** | **Código:** `MOD-07` | **Nivel de Usuario:** Básico / Operador / Experto  
**Archivo Fuente**: [`grid_generator.py`](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/grid_generator.py)  
**Lanzador Rápido**: Botón 5 en [`main.py`](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/main.py) o `python grid_generator.py`
...
- [[CAT-102_Sintesis_Cristalografica_Redes_2D_y_Particula_Ancla|📐 CAT-102: Síntesis Cristalográfica de Redes 2D y Ancla P0]]
...
- [[CAT-305_Derivacion_Matematica_Factor_Estructura_Debye_Waller|📐 CAT-305: Derivación Factor Estructura y Debye-Waller]]
- [[CAT-307_Computacion_NUFFT_Factor_Estructura_Optimizacion_BLAS|⚡ CAT-307: Computación NUFFT 2D y Optimización BLAS]]
- [[CAT-101_Protocolo_Operativo_Impresion_Fototermica_Grillas_2D|🔬 CAT-101: Protocolo de Impresión Fototérmica de Grillas 2D]]
