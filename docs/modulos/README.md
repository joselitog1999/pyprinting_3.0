...
| **09** | **PySpectrum 3.0 (`pyspectrum.py` / `pyspectrum/`)** | Suite de espectroscopía, Andor Shamrock/CCD, cosido Step & Glue, mapeo hiperespectral 2D/3D y cinéticas. | 🟢 Operativo | [09_PySpectrum_Espectroscopia.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/docs/modulos/09_PySpectrum_Espectroscopia.md) |
