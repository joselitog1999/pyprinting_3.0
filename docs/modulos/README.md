...
|:---:|---|---|:---:|:---:|
| **00** | **Fundamentos Físicos & Nanomateriales** | Compendio teórico exhaustivo: Pinzas Ópticas, LSPR, termoplasmónica, química DLVO y Optical Printing. | 🟢 Referencia | [00_Fundamentos_Fisicos_Optical_Printing_y_Nanomateriales.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/docs/modulos/00_Fundamentos_Fisicos_Optical_Printing_y_Nanomateriales.md) |
| **01** | **Microscopio Derecho (`app.py`)** | Suite principal multihilo: Mapeo Confocal 2D/3D con corrección Z en 4 esquinas (*Confocal Tilt*), Trazas $10\ \text{kHz}$, Autofoco Axial Z, Nanoposicionamiento PI y dock de Shutters/Flipper desacoplado con watchdog fail-safe. | 🟢 Operativo | [01_Microscopio_Derecho_App.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/docs/modulos/01_Microscopio_Derecho_App.md) |
| **02** | **Rutinas de Impresión y Dímeros (`modules/measurements.py`)** | Motor de nanofabricación fototérmica: Grillas $N \times M$, 5 Criterios de Parada, Autocompletitud Inteligente (*Healing Pass* con autofoco in-situ), Deriva Adaptativa $\vec{v}_{\text{drift}}$ y ETA. | 🟢 Operativo | [02_Measurements_Printing_y_Dimers.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/docs/modulos/02_Measurements_Printing_y_Dimers.md) |
...
| **09** | **PySpectrum 3.0 (`pyspectrum.py` / `pyspectrum/`)** | Suite completa de espectroscopía: Andor Shamrock 500i / iXon3 CCD, cosido Step & Glue, dock de calibración de hardware (orden 0 sub-píxel, offsets Ctypes, calibración polinomial cúbica y halógena NIST). | 🟢 Operativo | [09_PySpectrum_Espectroscopia.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/docs/modulos/09_PySpectrum_Espectroscopia.md) |
...
| **13** | **Raman Analyzer Suite (`raman_analyzer.py`)** | Procesamiento espectral Raman/SERS avanzado: importador Solis/Witec/Renishaw, tri-modal baseline (fondo/individual/ninguno), pestaña de inspección raw+línea base, slider estricto 0/100 de tema visual y exportación a 600 DPI. | 🟢 Operativo | [13_Raman_Analyzer_Suite.md](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/docs/modulos/13_Raman_Analyzer_Suite.md) |
