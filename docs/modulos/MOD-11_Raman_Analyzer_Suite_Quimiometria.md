# MOD-11: Suite de Análisis Espectral y Quimiometría Raman 📊

**PyPrinting 3.0 / PySpectrum 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Manual de Usuario Canónico** | **Código:** `MOD-11` | **Nivel de Usuario:** Intermedio / Avanzado  
...
- [`analysis/multi_spectrum_widget.py`](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/analysis/multi_spectrum_widget.py) (Suite multi-espectro, cascada 3D, heatmap y PCA)
- [`core/raman_engine.py`](file:///c:/Users/josel/Documents/Obsidian_Vault/printing3/core/raman_engine.py) (Motor quimiométrico desacoplado y algoritmos de línea base)
...
## 1. Resumen y Alcance Científico
...
- [[MOD-06_PySpectrum_Espectroscopia_Shamrock]] — Control instrumental de espectrómetro Shamrock 500i y cámara iXon3.
- [[MOD-12_Analizador_SIF_Andor_Solis]] — Procesamiento de mapas hiperespectrales binarios SIF.
- [[SYS-306_Arquitectura_Motor_Raman_y_Quimiometria_Multiespectral]] — Arquitectura de software, matemáticas de AsLS/AirPLS y descomposición PCA.
- [[SYS-301_Sistema_Espectrometro_Shamrock500i_iXon3]] — Hardware de espectroscopía y cámara EMCCD.
- [[SYS-305_Arquitectura_Optomecanica_Microscopio_Derecho_y_Ruteo_Espectral]] — Ruteo óptico hacia el puerto de espectroscopía.
- [[CAT-109_Electrodinamica_Fuerzas_Opticas_y_Termoplasmonica_Printing]] — Nanotermometría plasmónica y nanodímeros SERS.
- [[CAT-401_Estandar_Serializacion_Jerarquica_Contenedor_HDF5]] — Exportación y persistencia de lotes espectrales en HDF5.
