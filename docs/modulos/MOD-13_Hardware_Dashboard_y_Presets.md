# MOD-13: Tablero de Seguridad de Hardware y Asistente de Presets 🛡️

**PyPrinting 3.0 — Suite de Nanofotónica y Control Instrumental**  
**Laboratorio de Nanofotónica — Instituto de Nanosistemas (INS-UNSAM / CONICET)**  
**Manual de Usuario Canónico** | **Código:** `MOD-13` | **Nivel de Usuario:** Básico / Operador / Experto  
...
- [[SYS-201_Seguridad_Optica_Watchdog_y_Obturadores|🔒 SYS-201: Seguridad Óptica, Watchdog y Obturadores]]
