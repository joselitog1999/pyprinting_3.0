# MOD-02: Rutinas de Impresión y Dímeros (Nanofabricación) 🔬
...
* **Fundamentos Científicos Asociados:**
  ...
  * `[[CAT-106_Control_Adaptativo_Frecuencia_Autofoco_Gradiente_Deriva]]`
  ...
  * `[[CAT-110_Fisicoquimica_Coloides_DLVO_y_Funcionalizacion_Superficies]]`
...
> * Para la fundamentación teórica de la detección fototérmica, fotodiodos y tiempos de respuesta, consultar `[[CAT-101_Protocolo_Operativo_Impresion_Fototermica_Grillas_2D]]` y `[[CAT-107_Cinetica_Captura_Fotodiodo_Time_Volt_Filtro_Nhold]]`.
> * Para el control de lazo cerrado óptico en la síntesis de nanodímeros plasmónicos, consultar `[[CAT-103_Control_Lazo_Cerrado_Fototermico_y_Sintesis_Dimeros]]`.
> * Para el algoritmo de compensación de deriva con la partícula ancla P0, consultar `[[CAT-105_Compensacion_Deriva_Termomecanica_Particula_Ancla_P0]]` y `[[CAT-106_Control_Adaptativo_Frecuencia_Autofoco_Gradiente_Deriva]]`.
...
- [[MOD-01_Microscopio_Derecho_App]] — Control del escáner confocal, platina PI E-517 y autofoco.
- [[MOD-07_Disenador_Redes_2D_Grid_Generator]] — Diseñador de recetas y mallas 2D con partícula ancla P0.
- [[MOD-14_Protocolos_Laboratorio_SOP]] — Protocolo paso a paso para experimentos de impresión en el laboratorio.
- [[CAT-101_Protocolo_Operativo_Impresion_Fototermica_Grillas_2D]] — Protocolo experimental exhaustivo de impresión óptica.
- [[CAT-103_Control_Lazo_Cerrado_Fototermico_y_Sintesis_Dimeros]] — Ensamblado nanométrico de dímeros plasmónicos.
- [[CAT-105_Compensacion_Deriva_Termomecanica_Particula_Ancla_P0]] — Algoritmo de corrección de deriva termomecánica.
- [[CAT-106_Control_Adaptativo_Frecuencia_Autofoco_Gradiente_Deriva]] — Control adaptativo de autofoco por gradiente de deriva.
- [[CAT-107_Cinetica_Captura_Fotodiodo_Time_Volt_Filtro_Nhold]] — Modelado de trazas temporales y filtro Nhold.
- [[SYS-101_Arquitectura_Hilos_Concurrencia_QThread]] — Arquitectura de hilos y ejecución en segundo plano.
