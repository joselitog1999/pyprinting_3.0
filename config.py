...
SHUTTER_CHANNELS = [11, 8, 9]
SHUTTER_POLARITY = {SHUTTERS[0]: False, SHUTTERS[1]: True, SHUTTERS[2]: True}
...
PD_CHAN_BS    = 6
PD_CHANNELS   = {SHUTTERS[0]: 0, SHUTTERS[1]: 2, SHUTTERS[2]: 1, "BS": PD_CHAN_BS}
